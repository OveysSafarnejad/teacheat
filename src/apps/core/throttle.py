...
from apps.core.utils import verify_recaptcha
# from apps.users.models import User


class AnonUserCustomThrottleClass(SimpleRateThrottle):
    scope = 'CustomAnonUserRateThrottle'
    ...
    @staticmethod
    def check_recaptcha(request, view):
